...
class Encoders
{
    ...
    public static function encrypt_request($data, $secretKey)
    {
        // Choose an encryption algorithm and mode (e.g., AES-256-CBC)
        $cipher = 'aes-256-cbc';
        ...
        // Concatenate IV with encrypted data (IV will be needed for decryption)
